...
@RestController
@RequestMapping("/api/redress-kafka")
public class RedressKafkaResource {
    private final Logger log = LoggerFactory.getLogger(RedressKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public RedressKafkaResource(KafkaProperties kafkaProperties) {
